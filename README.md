...
| `history.jsonl` | per turn the `train/`, `val/`, `test/` values, `global_step`, `lr/<optimizer>`, `minimizes/<optimizer>` (the loss it stepped on that turn), `seconds`, the rules that fired |
